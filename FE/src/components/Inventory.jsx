...
const Inventory = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `https://inventory-q0g5.onrender.com/inventory?username=${username}`
      );
  ...
  const handleAdd = async () => {
    ...
    if (itemName && itemPrice) {
      try {
        await axios.post("https://inventory-q0g5.onrender.com/inventory", {
          username,
          itemName,
          itemPrice,
        }).then((res) => {
  ...
  const handleAddStock = async (index) => {
    ...
    try {
      await axios.post("https://inventory-q0g5.onrender.com/updateStock", {
        username,
